...
public class UFE : MonoBehaviour, UFEInterface
{
    ...
    private static void _StartGame(float fadeTime){
		...
		if (cScript1 != null && cScript2 != null)
		{
            ...
            {
                UFE.debugger1 = UFE.DebuggerText("Debugger1", "", new Vector2(-Screen.width + 1100, Screen.height - 1000), TextAnchor.MiddleLeft);
                UFE.p1ControlsScript.debugger = UFE.debugger1;
            }

            if (UFE.debugger2 == null)
            {
                UFE.debugger2 = UFE.DebuggerText("Debugger2", "", new Vector2(Screen.width - 1100, Screen.height - 1000), TextAnchor.MiddleRight);
